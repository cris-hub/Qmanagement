...
//METODO PARA LA CREACION DE UN ESCENARIO DE UN PROYECTO
    public String crearAsignacion() {
        ...
        try {
            ...
            asignacionNueva.setAnalistadecalidad(calidadFacade.find(calidad.getIdUsuarios()));
            asignacionNueva.setAnalistadeprueba(pruebaFacade.find(prueba.getIdUsuarios()));
            asignacionNueva.setDesarrollo(desarrolloFacade.find(desarrollo.getIdUsuarios()));
            asignacionNueva.setIdEscenario(escenarioFacade.find(escenario.getIdEscenario()));
            asignacionNueva.setIdCore(coreFacade.find(core.getIdCore()));
